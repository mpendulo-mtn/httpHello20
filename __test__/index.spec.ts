...
import { httpHello20 } from '../src/functions/index';

describe('httpHello20 function', () => {
  ...
  it('should return "Hello, world!" when no name is provided', async () => {
    const result = await httpHello20(mockRequest as any, mockContext as any);
  ...
  it('should return "Hello, Bob!" when the name is provided in the body', async () => {
    ...
    const result = await httpHello20(mockRequest as HttpRequest, mockContext as InvocationContext);
